    ...
    <div className={`py-16 sm:py-24`}>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Unlock Delicious Insights with Our Newsletter!
          </h2>
          <p
          ...
          >
            Join our food tour journey and receive regular updates on the best culinary experiences around. Be the first to know, with special perks and exclusive content just for our subscribers.
          </p>
